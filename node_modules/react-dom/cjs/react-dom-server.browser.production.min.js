...
}if(null!=h.style&&"object"!==typeof h.style)throw r(62,"");}h=e;g=this.makeStaticMarkup;H=1===this.stack.length;F="<"+a.type;for(z in h)if(Ra.call(h,z)){var m=h[z];if(null!=m){if("style"===z){p=void 0;var k="",u="";for(p in m)if(m.hasOwnProperty(p)){var q=0===p.indexOf("--"),y=m[p];if(null!=y){var w=p;if(Pa.hasOwnProperty(w))w=Pa[w];else{var R=w.replace(Ja,"-$1").toLowerCase().replace(Ka,"-ms-");w=Pa[w]=R}k+=u+w+":";u=p;q=null==y||"boolean"===typeof y||""===y?"":q||"number"!==typeof y||0===y||Y.hasOwnProperty(u)&&
Y[u]?(""+y).trim():y+"px";k+=q;u=";"}}m=k||null}p=null;b:if(q=b,y=h,-1===q.indexOf("-"))q="string"===typeof y.is;else switch(q){case "annotation-xml":case "color-profile":case "font-face":case "font-face-src":case "font-face-uri":case "font-face-format":case "font-face-name":case "missing-glyph":q=!1;break b;default:q=!0}q?Sa.hasOwnProperty(z)||(p=z,p=sa(p)&&null!=m?p+"="+('"'+M(m)+'"'):""):p=wa(z,m);p&&(F+=" "+p)}}g||H&&(F+=' data-reactroot=""');var z=F;h="";Ga.hasOwnProperty(b)?z+="/>":(z+=">",
